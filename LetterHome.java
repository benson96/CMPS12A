// the first error is "sentenceCode >= Max_CODE", It should be "sentenceCode > Max_CODE".
// the second error is "else; if", it should be "else if".
// the thied error is "if(m == 2);", it should be " if(m ==2)".
